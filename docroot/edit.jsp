...
<jsp:useBean id="pref_mpiStart"              class="java.lang.String" scope="request"/>
<jsp:useBean id="pref_mpiHooks"              class="java.lang.String" scope="request"/>
...
<tr>    
  <td align="center" ><input type="submit" valign="middle" onclick="setAction('viewPilot');" value="Change"></td>
  <td>
      <input type="text" style="width: 320px; padding: 2px" name="pref_pilotScript" id="pilotScript"                     value="<%=pref_pilotScript %>"><br/>  
      <input type="text" style="width: 320px; padding: 2px" name="pref_mpiStart"    id="mpiStart"    readonly="readonly" value="<%=pref_mpiStart %>">   <br/>  
      <input type="text" style="width: 320px; padding: 2px" name="pref_mpiHooks"    id="mpiHooks"    readonly="readonly" value="<%=pref_mpiHooks %>">
  </td>  
</tr>
<!--
    Preference buttons
