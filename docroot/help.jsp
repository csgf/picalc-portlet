...
<pre><b>This is a demonstrative portlet which computes the Pi number using the MPI library for parallel procesing.</b></pre>
...
Author: Ruccardo Bruno (INFN.Dpt of Catania) - riccardo.bruno@ct.infn.it
</pre>
