...
<jsp:useBean id="mpiStart"    class="java.lang.String" scope="request"/>
<jsp:useBean id="mpiHooks"    class="java.lang.String" scope="request"/>
...
<dl>
        <!-- This block contains: textarea for the pilot script file -->
	<dd>
            <p><b>Pilot script</b>
        </dd>
        <dd>		 		 
	...
	<!-- This block contains: textarea for MPI Start script file -->
	<dd>
            <p><b>MPI Start</b>
        </dd>
        <dd>		 		 
	    <textarea style="font-family:monospace; font-size:12px;" id="mpiStart" rows="20" cols="100%" name="pilotScript"><%=mpiStart%></textarea>
	</dd>
        <!-- This block contains: textarea for MPI Hooks script file -->
	<dd>
            <p><b>MPI Hooks</b>
        </dd>
        <dd>		 		 
	    <textarea style="font-family:monospace; font-size:12px;" id="mpiHooks" rows="20" cols="100%" name="pilotScript"><%=mpiHooks%></textarea>
	</dd>
